...
<div class="a-section a-spacing-none">
    ...
    <div class="a-section abbott-view-content">
      <div class="a-section a-padding-small">
              ...
              <form id="abbott-form" method="get" action="#">
                <input type="hidden" name="__token_" value="g2HLuWFH6+qaHsM+e3xyPoiT23CE0vRKgXQ0DjfI91OJAAAAAQAAAABiqHhgcmF3AAAAAA1hD7augC3xPcX5I/a6ow==">
        ...
        <div class="a-box a-alert a-alert-success" role="alert"><div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">Account reactivated</h4><div class="a-alert-content">
            <div class="a-section">
            Thank you for providing the information necessary to reactivate your account.
            </div>
      ...
      <div id="header-1" class="a-section a-spacing-mini abbott-view-component component-display-block component-width-extra_large">
						<h1 data-action-on-load="register-listeners" data-listeners="" class="a-size-large has-action-on-load text-align-left a-text-bold">

                            <center><div class="loader-gif" style="width:120px; height:120px; background-color: #fff; border: 1px solid lightgrey; border-radius:0.4rem; display:flex; justify-content:center; padding:10px;">
